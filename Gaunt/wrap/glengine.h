...
#include <gl/glext.h>
#else
#error glengine.h is not configured on this platform
#endif

bool HaveGLExtension(const char* ext);
bool HaveGLCore(unsigned major, unsigned minor);

// Must be 0 or a string literal
#define REQ_GL_VERSION_1_2 "GL_VERSION_1_2"
#define REQ_GL_VERSION_1_3 "GL_VERSION_1_3"
#define REQ_GL_VERSION_1_4 "GL_VERSION_1_4"
#define REQ_GL_VERSION_1_5 "GL_VERSION_1_5"
#define REQ_GL_VERSION_2_0 "GL_VERSION_2_0"
#define REQ_GL_VERSION_2_1 "GL_VERSION_2_1"
#define REQ_GL_VERSION_3_0 0
#define REQ_GL_VERSION_3_1 0
#define REQ_GL_VERSION_3_2 0
#define REQ_GL_VERSION_3_3 0
#define REQ_GL_VERSION_4_0 0
#define REQ_GL_VERSION_4_1 0
#define REQ_GL_VERSION_4_2 0
#define REQ_GL_VERSION_4_3 0
#define REQ_GL_VERSION_4_4 0
#define REQ_GL_VERSION_4_5 0
#define REQ_GL_VERSION_4_6 0
#if 0
#define REQ_GL_ARB_ES3_2_compatibility 0
#define REQ_GL_ARB_bindless_texture 0
#define REQ_GL_ARB_cl_event 0
#define REQ_GL_ARB_color_buffer_float 0
#define REQ_GL_ARB_compute_variable_group_size 0
#define REQ_GL_ARB_debug_output 0
#define REQ_GL_ARB_draw_buffers 0
#define REQ_GL_ARB_draw_buffers_blend 0
#define REQ_GL_ARB_draw_instanced 0
#define REQ_GL_ARB_fragment_program 0
#define REQ_GL_ARB_geometry_shader4 0
#define REQ_GL_ARB_gl_spirv 0
#define REQ_GL_ARB_gpu_shader_int64 0
#define REQ_GL_ARB_imaging 0
#define REQ_GL_ARB_indirect_parameters 0
#define REQ_GL_ARB_instanced_arrays 0
#define REQ_GL_ARB_matrix_palette 0
#define REQ_GL_ARB_multisample 0
#define REQ_GL_ARB_multitexture 0
#define REQ_GL_ARB_occlusion_query 0
#define REQ_GL_ARB_parallel_shader_compile 0
#define REQ_GL_ARB_point_parameters 0
#define REQ_GL_ARB_robustness 0
#define REQ_GL_ARB_sample_locations 0
#define REQ_GL_ARB_sample_shading 0
#define REQ_GL_ARB_shader_objects 0
#define REQ_GL_ARB_shading_language_include 0
#define REQ_GL_ARB_sparse_buffer 0
#define REQ_GL_ARB_sparse_texture 0
#define REQ_GL_ARB_texture_buffer_object 0
#define REQ_GL_ARB_texture_compression 0
#define REQ_GL_ARB_transpose_matrix 0
#define REQ_GL_ARB_vertex_blend 0
#define REQ_GL_ARB_vertex_buffer_object 0
#define REQ_GL_ARB_vertex_program 0
#define REQ_GL_ARB_vertex_shader 0
#define REQ_GL_ARB_window_pos 0
#define REQ_GL_KHR_blend_equation_advanced 0
#define REQ_GL_KHR_parallel_shader_compile 0
#define REQ_GL_OES_byte_coordinates 0
#define REQ_GL_OES_fixed_point 0
#define REQ_GL_OES_query_matrix 0
#define REQ_GL_OES_single_precision 0
#define REQ_GL_3DFX_tbuffer 0
#define REQ_GL_AMD_debug_output 0
#define REQ_GL_AMD_draw_buffers_blend 0
#define REQ_GL_AMD_framebuffer_multisample_advanced 0
#define REQ_GL_AMD_framebuffer_sample_positions 0
#define REQ_GL_AMD_gpu_shader_int64 0
#define REQ_GL_AMD_interleaved_elements 0
#define REQ_GL_AMD_multi_draw_indirect 0
#define REQ_GL_AMD_name_gen_delete 0
#define REQ_GL_AMD_occlusion_query_event 0
#define REQ_GL_AMD_performance_monitor 0
#define REQ_GL_AMD_sample_positions 0
#define REQ_GL_AMD_sparse_texture 0
#define REQ_GL_AMD_stencil_operation_extended 0
#define REQ_GL_AMD_vertex_shader_tessellator 0
#define REQ_GL_APPLE_element_array 0
#define REQ_GL_APPLE_fence 0
#define REQ_GL_APPLE_flush_buffer_range 0
#define REQ_GL_APPLE_object_purgeable 0
#define REQ_GL_APPLE_texture_range 0
#define REQ_GL_APPLE_vertex_array_object 0
#define REQ_GL_APPLE_vertex_array_range 0
#define REQ_GL_APPLE_vertex_program_evaluators 0
#define REQ_GL_ATI_draw_buffers 0
#define REQ_GL_ATI_element_array 0
#define REQ_GL_ATI_envmap_bumpmap 0
#define REQ_GL_ATI_fragment_shader 0
#define REQ_GL_ATI_map_object_buffer 0
#define REQ_GL_ATI_pn_triangles 0
#define REQ_GL_ATI_separate_stencil 0
#define REQ_GL_ATI_vertex_array_object 0
#define REQ_GL_ATI_vertex_attrib_array_object 0
#define REQ_GL_ATI_vertex_streams 0
#define REQ_GL_EXT_EGL_image_storage 0
#define REQ_GL_EXT_bindable_uniform 0
#define REQ_GL_EXT_blend_color 0
#define REQ_GL_EXT_blend_equation_separate 0
#define REQ_GL_EXT_blend_func_separate 0
#define REQ_GL_EXT_blend_minmax 0
#define REQ_GL_EXT_color_subtable 0
#define REQ_GL_EXT_compiled_vertex_array 0
#define REQ_GL_EXT_convolution 0
#define REQ_GL_EXT_coordinate_frame 0
#define REQ_GL_EXT_copy_texture 0
#define REQ_GL_EXT_cull_vertex 0
#define REQ_GL_EXT_debug_label 0
#define REQ_GL_EXT_debug_marker 0
#define REQ_GL_EXT_depth_bounds_test 0
#define REQ_GL_EXT_direct_state_access 0
#define REQ_GL_EXT_draw_buffers2 0
#define REQ_GL_EXT_draw_instanced 0
#define REQ_GL_EXT_draw_range_elements 0
#define REQ_GL_EXT_external_buffer 0
#define REQ_GL_EXT_fog_coord 0
#define REQ_GL_EXT_framebuffer_blit 0
#define REQ_GL_EXT_framebuffer_multisample 0
#define REQ_GL_EXT_framebuffer_object 0
#define REQ_GL_EXT_geometry_shader4 0
#define REQ_GL_EXT_gpu_program_parameters 0
#define REQ_GL_EXT_gpu_shader4 0
#define REQ_GL_EXT_histogram 0
#define REQ_GL_EXT_index_func 0
#define REQ_GL_EXT_index_material 0
#define REQ_GL_EXT_light_texture 0
#define REQ_GL_EXT_memory_object 0
#define REQ_GL_EXT_memory_object_fd 0
#define REQ_GL_EXT_memory_object_win32 0
#define REQ_GL_EXT_multi_draw_arrays 0
#define REQ_GL_EXT_multisample 0
#define REQ_GL_EXT_paletted_texture 0
#define REQ_GL_EXT_pixel_transform 0
#define REQ_GL_EXT_point_parameters 0
#define REQ_GL_EXT_polygon_offset 0
#define REQ_GL_EXT_polygon_offset_clamp 0
#define REQ_GL_EXT_provoking_vertex 0
#define REQ_GL_EXT_raster_multisample 0
#define REQ_GL_EXT_secondary_color 0
#define REQ_GL_EXT_semaphore 0
#define REQ_GL_EXT_semaphore_fd 0
#define REQ_GL_EXT_semaphore_win32 0
#define REQ_GL_EXT_separate_shader_objects 0
#define REQ_GL_EXT_shader_framebuffer_fetch_non_coherent 0
#define REQ_GL_EXT_shader_image_load_store 0
#define REQ_GL_EXT_stencil_clear_tag 0
#define REQ_GL_EXT_stencil_two_side 0
#define REQ_GL_EXT_subtexture 0
#define REQ_GL_EXT_texture3D 0
#define REQ_GL_EXT_texture_array 0
#define REQ_GL_EXT_texture_buffer_object 0
#define REQ_GL_EXT_texture_integer 0
#define REQ_GL_EXT_texture_object 0
#define REQ_GL_EXT_texture_perturb_normal 0
#define REQ_GL_EXT_timer_query 0
#define REQ_GL_EXT_transform_feedback 0
#define REQ_GL_EXT_vertex_array 0
#define REQ_GL_EXT_vertex_attrib_64bit 0
#define REQ_GL_EXT_vertex_shader 0
#define REQ_GL_EXT_vertex_weighting 0
#define REQ_GL_EXT_win32_keyed_mutex 0
#define REQ_GL_EXT_window_rectangles 0
#define REQ_GL_EXT_x11_sync_object 0
#define REQ_GL_GREMEDY_frame_terminator 0
#define REQ_GL_GREMEDY_string_marker 0
#define REQ_GL_HP_image_transform 0
#define REQ_GL_IBM_multimode_draw_arrays 0
#define REQ_GL_IBM_static_data 0
#define REQ_GL_IBM_vertex_array_lists 0
#define REQ_GL_INGR_blend_func_separate 0
#define REQ_GL_INTEL_framebuffer_CMAA 0
#define REQ_GL_INTEL_map_texture 0
#define REQ_GL_INTEL_parallel_arrays 0
#define REQ_GL_INTEL_performance_query 0
#define REQ_GL_MESA_resize_buffers 0
#define REQ_GL_MESA_window_pos 0
#define REQ_GL_NVX_conditional_render 0
#define REQ_GL_NVX_linked_gpu_multicast 0
#define REQ_GL_NV_alpha_to_coverage_dither_control 0
#define REQ_GL_NV_bindless_multi_draw_indirect 0
#define REQ_GL_NV_bindless_multi_draw_indirect_count 0
#define REQ_GL_NV_bindless_texture 0
#define REQ_GL_NV_blend_equation_advanced 0
#define REQ_GL_NV_clip_space_w_scaling 0
#define REQ_GL_NV_command_list 0
#define REQ_GL_NV_conditional_render 0
#define REQ_GL_NV_conservative_raster 0
#define REQ_GL_NV_conservative_raster_dilate 0
#define REQ_GL_NV_conservative_raster_pre_snap_triangles 0
#define REQ_GL_NV_copy_image 0
#define REQ_GL_NV_depth_buffer_float 0
#define REQ_GL_NV_draw_texture 0
#define REQ_GL_NV_draw_vulkan_image 0
#define REQ_GL_NV_evaluators 0
#define REQ_GL_NV_explicit_multisample 0
#define REQ_GL_NV_fence 0
#define REQ_GL_NV_fragment_coverage_to_color 0
#define REQ_GL_NV_fragment_program 0
#define REQ_GL_NV_framebuffer_mixed_samples 0
#define REQ_GL_NV_framebuffer_multisample_coverage 0
#define REQ_GL_NV_geometry_program4 0
#define REQ_GL_NV_gpu_multicast 0
#define REQ_GL_NV_gpu_program4 0
#define REQ_GL_NV_gpu_program5 0
#define REQ_GL_NV_half_float 0
#define REQ_GL_NV_internalformat_sample_query 0
#define REQ_GL_NV_memory_attachment 0
#define REQ_GL_NV_mesh_shader 0
#define REQ_GL_NV_occlusion_query 0
#define REQ_GL_NV_parameter_buffer_object 0
#define REQ_GL_NV_path_rendering 0
#define REQ_GL_NV_pixel_data_range 0
#define REQ_GL_NV_point_sprite 0
#define REQ_GL_NV_present_video 0
#define REQ_GL_NV_primitive_restart 0
#define REQ_GL_NV_query_resource 0
#define REQ_GL_NV_query_resource_tag 0
#define REQ_GL_NV_register_combiners 0
#define REQ_GL_NV_register_combiners2 0
#define REQ_GL_NV_sample_locations 0
#define REQ_GL_NV_scissor_exclusive 0
#define REQ_GL_NV_shader_buffer_load 0
#define REQ_GL_NV_shading_rate_image 0
#define REQ_GL_NV_texture_barrier 0
#define REQ_GL_NV_texture_multisample 0
#define REQ_GL_NV_transform_feedback 0
#define REQ_GL_NV_transform_feedback2 0
#define REQ_GL_NV_vdpau_interop 0
#define REQ_GL_NV_vdpau_interop2 0
#define REQ_GL_NV_vertex_array_range 0
#define REQ_GL_NV_vertex_attrib_integer_64bit 0
#define REQ_GL_NV_vertex_buffer_unified_memory 0
#define REQ_GL_NV_vertex_program 0
#define REQ_GL_NV_vertex_program4 0
#define REQ_GL_NV_video_capture 0
#define REQ_GL_NV_viewport_swizzle 0
#define REQ_GL_OVR_multiview 0
#define REQ_GL_PGI_misc_hints 0
#define REQ_GL_SGIS_detail_texture 0
#define REQ_GL_SGIS_fog_function 0
#define REQ_GL_SGIS_multisample 0
#define REQ_GL_SGIS_pixel_texture 0
#define REQ_GL_SGIS_point_parameters 0
#define REQ_GL_SGIS_sharpen_texture 0
#define REQ_GL_SGIS_texture4D 0
#define REQ_GL_SGIS_texture_color_mask 0
#define REQ_GL_SGIS_texture_filter4 0
#define REQ_GL_SGIX_async 0
#define REQ_GL_SGIX_flush_raster 0
#define REQ_GL_SGIX_fragment_lighting 0
#define REQ_GL_SGIX_framezoom 0
#define REQ_GL_SGIX_igloo_interface 0
#define REQ_GL_SGIX_instruments 0
#define REQ_GL_SGIX_list_priority 0
#define REQ_GL_SGIX_pixel_texture 0
#define REQ_GL_SGIX_polynomial_ffd 0
#define REQ_GL_SGIX_reference_plane 0
#define REQ_GL_SGIX_sprite 0
#define REQ_GL_SGIX_tag_sample_buffer 0
#define REQ_GL_SGI_color_table 0
#define REQ_GL_SUNX_constant_data 0
#define REQ_GL_SUN_global_alpha 0
#define REQ_GL_SUN_mesh_array 0
#define REQ_GL_SUN_triangle_list 0
#define REQ_GL_SUN_vertex 0
#endif
